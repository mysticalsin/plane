...
import { AthenaLockup } from "../../../athena/components/AthenaLogo";
        ...
        <div className="relative container mx-auto flex h-full w-full flex-col overflow-hidden overflow-y-auto px-5 py-14 md:px-0">
          <div className="relative flex flex-shrink-0 items-center justify-between gap-4">
            <div className="z-10 flex-shrink-0 bg-surface-2 py-4">
              <AthenaLockup className="h-9 w-auto text-primary" />
            </div>
            <div className="relative flex items-center gap-2">
              <div className="text-13 font-medium">{currentUser?.email}</div>
              {/* A button, not a div with a click handler: this is the only way off this screen
                  for someone who has landed on a workspace they cannot open, and a keyboard user
                  could not reach it. */}
              <button
                type="button"
                aria-label="Sign out"
