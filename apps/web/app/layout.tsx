...
const APP_TITLE = "Athena | Strategy into execution.";
const APP_DESCRIPTION = "Athena brings project management, team chat, and bid/delivery work into one place.";
...
export const meta = () => [
  ...
  { name: "description", content: APP_DESCRIPTION },
  {
    name: "keywords",
    content:
      "project management, team chat, bid management, delivery management, work item tracking, agile, scrum, kanban, collaboration",
  },
  {
    name: "viewport",
    content:
  ...
  { property: "og:image:alt", content: "Athena - Strategy into execution" },
  { name: "twitter:card", content: "summary_large_image" },
  { name: "twitter:image", content: ogImage },
  { name: "twitter:image:width", content: "1200" },
  { name: "twitter:image:height", content: "630" },
  { name: "twitter:image:alt", content: "Athena - Strategy into execution" },
];
  ...
  return (
    <html lang="en">
      <head>
        ...
        <link rel="icon" type="image/svg+xml" href="/athena-favicon.svg" />
